...
module.exports = function(context) {
    ...
    function checkSpacingInsideBraces(node) {
        ...
        var firstTokenIndex = tokensAndComments.indexOf(openBrace) + 1;
        var firstToken = tokensAndComments[firstTokenIndex];
        var lastTokenIndex = tokensAndComments.indexOf(closeBrace) - 1;
        var lastToken = tokensAndComments[lastTokenIndex];
